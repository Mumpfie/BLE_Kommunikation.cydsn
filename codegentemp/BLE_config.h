...
#define CY_BLE_SCN_PKT_0_INDEX_TX_POWER_LEVEL   (0x08u)
#define CY_BLE_SCN_PKT_0_INDEX_SERVICE_UUID_128   (0x0Bu)
...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x0018u)
...
#define CY_BLE_CONFIG_GATT_DB_ATT_VAL_COUNT         (0x1Cu)
...
#define CY_BLE_CONFIG_GATT_DB_CCCD_COUNT            (0x0Cu)
 ...
 */
#define CY_BLE_MEASUREMENT_SERVICE_SERVICE_INDEX   (0x00u) /* Index of Measurement Service service in the cy_ble_customs array */
#define CY_BLE_MEASUREMENT_SERVICE_VOLTAGE_CHAR_INDEX   (0x00u) /* Index of Voltage characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_VOLTAGE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_VOLTAGE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_CURRENT_CHAR_INDEX   (0x01u) /* Index of Current characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_CURRENT_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_CURRENT_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_TORQUE_CHAR_INDEX   (0x02u) /* Index of Torque characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_TORQUE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_TORQUE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_SPEED_CHAR_INDEX   (0x03u) /* Index of Speed characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_SPEED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_SPEED_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_EFFICIENCY_CHAR_INDEX   (0x04u) /* Index of Efficiency characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_EFFICIENCY_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_EFFICIENCY_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_MEASUREMENT_SERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of Measurement Service service */
#define CY_BLE_MEASUREMENT_SERVICE_VOLTAGE_DECL_HANDLE   (0x0011u) /* Handle of Voltage characteristic declaration */
#define CY_BLE_MEASUREMENT_SERVICE_VOLTAGE_CHAR_HANDLE   (0x0012u) /* Handle of Voltage characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_VOLTAGE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_VOLTAGE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_CURRENT_DECL_HANDLE   (0x0015u) /* Handle of Current characteristic declaration */
#define CY_BLE_MEASUREMENT_SERVICE_CURRENT_CHAR_HANDLE   (0x0016u) /* Handle of Current characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_CURRENT_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0017u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_CURRENT_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0018u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_TORQUE_DECL_HANDLE   (0x0019u) /* Handle of Torque characteristic declaration */
#define CY_BLE_MEASUREMENT_SERVICE_TORQUE_CHAR_HANDLE   (0x001Au) /* Handle of Torque characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_TORQUE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Bu) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_TORQUE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x001Cu) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_SPEED_DECL_HANDLE   (0x001Du) /* Handle of Speed characteristic declaration */
#define CY_BLE_MEASUREMENT_SERVICE_SPEED_CHAR_HANDLE   (0x001Eu) /* Handle of Speed characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_SPEED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Fu) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_SPEED_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0020u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_EFFICIENCY_DECL_HANDLE   (0x0021u) /* Handle of Efficiency characteristic declaration */
#define CY_BLE_MEASUREMENT_SERVICE_EFFICIENCY_CHAR_HANDLE   (0x0022u) /* Handle of Efficiency characteristic */
#define CY_BLE_MEASUREMENT_SERVICE_EFFICIENCY_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0023u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_MEASUREMENT_SERVICE_EFFICIENCY_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0024u) /* Handle of Client Characteristic Configuration descriptor */
